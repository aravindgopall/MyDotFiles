...
in {
  ...
  initExtra = ''
    ...
    export FZF_BASE=/home/monad/.nix-profile/bin/fzf
  ...
  shellAliases = {
    ...
    ga = "git add";
    gc = "git commit -p";
    hdmi2 = "xrandr --output HDMI2 --auto --mode 1920x1080 --output eDP1 --off";
    hdmi2back = "xrandr --output HDMI2 --off --output eDP1 --auto";
